...
import com.tiktok.auto.ui.dialog.ConfirmDialog
...
import com.tiktok.auto.bean.*
import com.tiktok.auto.ui.activity.SettingActivity
import com.tiktok.auto.ui.adapter.FunctionTypeAdapter
import com.tiktok.auto.ui.adapter.SpaceDecoration
import com.tiktok.auto.ui.dialog.OperationDialog
import com.tiktok.auto.ui.service.AccessService
import com.tiktok.auto.utils.ServiceAvailableUtils
import com.tiktok.auto.utils.ToastUtils
import com.tiktok.auto.utils.UiUtils
...
class HomeFragment : BaseFragment() {
    ...
    private fun onItemClick(item: FunctionType) {
        if (!App.getInstance().getAuth()){
            ToastUtils.showShort(getContext2(), "app未授权,请前往个人中心进行授权")
            return
        }
