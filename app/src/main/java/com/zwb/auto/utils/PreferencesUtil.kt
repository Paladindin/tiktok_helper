...
object PreferencesUtil {
    private const val name = "subtitle_key_value"
    private val prefs: SharedPreferences by lazy { App.getInstance().getSharedPreferences(
